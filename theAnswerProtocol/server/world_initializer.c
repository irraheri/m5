...
void initialize_npcs(t_all_npcs *npcs)
{
    ...
    strcpy(npcs->npcs[8].description,
        "A bald man in a plain cape, whose power is matched only by his ennui.");
    ...
    strcpy(npcs->npcs[9].description,
        "A man of wealth and bombast, standing atop the hill with a golden gaze.");
...
void initialize_items(t_all_items *items)
{
    ...
    strcpy(items->items[0].description,
        "A carved stone piece, simple but formidable in the endgame.");
    ...
    strcpy(items->items[4].description,
        "A heavy bar of pure gold, stamped with an ancient seal.");
    ...
    strcpy(items->items[5].description,
        "A symbol of ultimate achievement, coveted by all who seek glory.");
